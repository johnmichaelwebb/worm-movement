...
savename = 'Forwards vs Backwards'
...
nameOfHeatmapKind = 'N2_BACKWARDS' #This is the repeating element in your filenames to construct the 13x13 matrix from the 13x1 matrix
...
with open('N2_BACKWARDS0_CC_timelag_total.csv', newline='\n' ) as inputfile:
   cc = list(csv.reader(inputfile))  
with open('N2_BACKWARDS0_CC_PEAK_total.csv', newline='\n' ) as inputfile:
   cc_peak = list(csv.reader(inputfile)) 
with open('N2_BACKWARDS0_MI_total.csv', newline='\n' ) as inputfile:
