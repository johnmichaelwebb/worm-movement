...
savename_gross = 'N2_BACKWARDS' # This is tacked on to the saved filenames
interval = 3.69 #segment interval, to skip some segments; for example: 50/3.69 = 13 segments
instructions = 'N2_backwards_instructions.csv' ##FILE with the macro-level time points
backwards = True  # False means forward locomotion; True means backwards locomotion
###################################################################################
